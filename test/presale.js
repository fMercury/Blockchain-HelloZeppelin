...
contract('Friend Token Presale', function(accounts) {

  it("Should create a crowdsale", async function() {

    let weiRaised = new BigNumber(0);
    const maxCap = web3.toWei(100, 'ether');
    ...
    weiRaised = weiRaised.plus(web3.toWei(5, 'ether'));
    ...
    weiRaised = weiRaised.plus(web3.toWei(30, 'ether'));
